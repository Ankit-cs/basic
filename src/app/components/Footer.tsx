    ...
    <footer className="bg-stone-900 text-white" id="contact">
      <div className="container">
        <div className="section">
          <a
            href="https://drive.google.com/file/d/1000478455TN1ScwI0hxFQuN_MxywjRLc4PjlID8LB/view?usp=drivesdk"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 group/button hover:text-red-orange-500 transition-colors duration-300"
          >
        ...
        <div className="py-16 flex flex-wrap justify-between items-center gap-y-4">
          <p className="text-white/30 text-sm">
            Copyright &copy; {new Date().getFullYear()} Ankit Kumar • All rights
            reserved
          </p>
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/30 hover:text-white transition-colors duration-300 flex items-center gap-2 text-sm group/button"
            >
              <svg
                width="20"
                height="20"
